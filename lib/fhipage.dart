...
class FHiPage extends StatelessWidget {
  @override
          ...
          children: [
            Expanded(
              ...
              child: Container(
                ...
                width: 500,
                child: Image.asset(
                  'img/hi1.png', // ضع هنا مسار الصورة (Path of the image)
                  fit: BoxFit.fill,
            ...
            Expanded(
              ...
              child:Container(
                child: Padding(
                  ...
                  child: Text(
                    '!أشترك في مختلف النوادي الرياضية من بيتك',
            ...
            Padding(
              ...
              child: ElevatedButton(
                ...
                onPressed: () {
                  Navigator.pushNamed(context,'shi' ); // الانتقال عند الضغط على الزر
                },
